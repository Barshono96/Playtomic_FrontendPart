  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/createclubs/:userId" element={<ProtectedRoute element={<CreateClub />} />} />
        <Route path="/createcourts/:clubId/courts" element={<ProtectedRoute element={<ClubPage />} />} />
        {/* <Route path="/clubs/:clubId/courts" element={<ProtectedRoute element={<VcourtList />} />} /> */}
        ...
        <Route path="/searchcourt" element={<ProtectedRoute element={<SearchCourt />} />} />
        <Route path="*" element={<Error />} />
      </Routes>
    </Router>
  );
